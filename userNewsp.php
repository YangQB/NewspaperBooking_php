    ...
    <body>
      ...
      <?php 
		...
		if(!isset($_SESSION['identity'])||$_SESSION['identity']!="user"){
			...
			?>
            <form name="form_5" method="post" onsubmit="return checkinput(this);" action="userNewspBook.php">
              <table class="newsp">
                <tr class='newsp_1'>
                  <th></th>
                  <th>报刊编号</th>
			...
			while($row = mysql_fetch_array($result)){
				...
				echo "<td>"."<input type ='radio' name='choise' value=".$row['NID'].">"."</td>";
				echo "<td>".$row["NID"]."</td>";
			...
			?>
              <tr>
                  ...
                  <td></td>
                  <td></td>
                  <td><input type="submit" value="订阅" /></td>
                  <td></td>
                  <td></td>
                  <td></td>
                  <td></td>
